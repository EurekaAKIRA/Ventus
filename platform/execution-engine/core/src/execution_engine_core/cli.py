...
from execution_engine_core.config import TestConfig
from execution_engine_core.runner import TestRunner
...
@click.option(
    "--directory",
    "-d",
    default=str(Path(__file__).resolve().parents[2] / "examples" / "sites"),
    type=str,
    required=False,
