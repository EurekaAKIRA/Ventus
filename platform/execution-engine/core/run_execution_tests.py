"""Standalone launcher for execution-engine core test runner."""
...
def main() -> int:
    _extend_path()
    spec = importlib.util.find_spec("execution_engine_core.cli")
    if spec is None:
        raise RuntimeError("Cannot locate execution_engine_core.cli")
