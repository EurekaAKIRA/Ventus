...
from lavague_adapter.prompts import (
    ...
    def _run_lavague_agent(self):
        ...
        if self.full_llm:
            ...
            for step in self.scenario.steps:
                ...
                agent.run_step(step)
            print("Running final expectation check...")
