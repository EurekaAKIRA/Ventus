...
This repository is being reorganized in-place into a platform-first architecture for the graduation project.

Current recommended entrypoints and documents:

- `platform/`
- `docs/project_requirements.md`
- `docs/architecture_replan.md`
...
`task-center -> requirement-analysis -> case-generation -> execution-engine -> result-analysis -> platform-ui`

In this new architecture, `LaVague` is treated as an execution adapter under:

- `platform/execution-engine/lavague-adapter`

The legacy directories are still present for migration and compatibility, but new development should prefer `platform/`.
